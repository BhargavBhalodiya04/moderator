...
export const MCP_BANNER_COPY =
  "Moderator MCP: debug traces and fix failing evals from Claude Code or Codex.";

export const MCP_BANNER_COPY_SHORT = "Moderator MCP: debug traces with your agent.";
