...
export const MCP_HINT_TITLE = "Moderator MCP";

export const MCP_HINT_DESCRIPTION =
  "Instead of writing a script for each question, your agent reads Moderator directly — and can fix the code in the same step.";
