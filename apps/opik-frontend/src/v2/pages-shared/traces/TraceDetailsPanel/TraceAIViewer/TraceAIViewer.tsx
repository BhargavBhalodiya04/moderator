...
import TraceChatInput from "@/v2/pages-shared/traces/TraceDetailsPanel/TraceAIViewer/TraceChatInput";
import TraceChatMessage from "@/v2/pages-shared/traces/TraceDetailsPanel/TraceAIViewer/TraceChatMessage";
import TraceSessionFeedback from "@/v2/pages-shared/traces/TraceDetailsPanel/TraceAIViewer/TraceSessionFeedback";
...
const TraceAIViewer: React.FC<TraceAIViewerProps> = ({
    ...
    return (
      <div className="flex min-h-full flex-col items-center justify-center gap-3 py-2">
        <div className="comet-title-m text-center text-foreground">
          Debug your trace with ModeratorAssist
        </div>
  ...
  return (
    <DetailsActionSectionLayout
      title="ModeratorAssist"
      closeTooltipContent="Close ModeratorAssist"
