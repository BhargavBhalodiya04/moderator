...
export const guardrailsMap: Record<GuardrailTypes, GuardrailConfig> = {
  ...
  [GuardrailTypes.LLM_JUDGE]: {
    ...
    hintText:
      "The LLM judge guardrail validates text against a natural-language policy using an LLM. It runs in the SDK against the provider configured in your Moderator workspace and does not require the guardrails server.",
    enabled: false,
