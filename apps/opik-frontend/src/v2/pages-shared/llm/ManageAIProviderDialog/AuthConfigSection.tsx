    ...
    <FormFieldCard title="Authentication" bodyClassName="flex flex-col gap-4">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <ExplainerIcon description="Moderator requests a short-lived access token from your auth service using the OAuth2 client credentials grant and attaches it to every model call, refreshing it automatically before expiry." />
        </div>
      </RadioGroup>
