      ...
      <DialogContent className="max-w-[790px] gap-2">
        ...
        <DialogAutoScrollBody>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div className="rounded-lg border bg-background p-4">
              ...
              <div className="space-y-2">
                ...
                >
                  Getting started with Moderator
                ...
                <a
                  ...
                  className="comet-body-s flex items-center gap-1 text-primary hover:underline dark:text-primary-hover"
                >
                  Moderator&apos;s open-source collection of cookbooks
                  <ExternalLink className="size-4" />
                </a>
                <a
                  href={buildDocsUrl("/integrations/overview")}
                  ...
                  className="comet-body-s flex items-center gap-1 text-primary hover:underline dark:text-primary-hover"
                >
                  Integrate Moderator with your LLM application
                  <ExternalLink className="size-4" />
                </a>
                <a
          ...
          <HelpLinks
            ...
            description="Explore Moderator by testing things out in the playground or browsing our Demo project. No setup required."
          >
