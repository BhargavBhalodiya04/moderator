...
const InstallWithAITab: React.FC<InstallWithAITabProps> = ({
  ...
  const prompt = `Instrument my agent with Moderator using the /opik-instrument command. Make sure you use workspace "${workspaceName}"${projectPart} and API key "${
    apiKey ?? "<YOUR_API_KEY>"
  }".`;
      ...
      <div className="flex flex-col">
        <TimelineStep number={1}>
          <div className="flex flex-col gap-2.5">
            <h4 className="comet-body-s-accented">Add the Moderator skill</h4>
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="comet-body-xs text-muted-slate">
                {traceReceived ? (
                  ...
                  <>
                    Connect your agent to Moderator for observability, evaluation and
                    optimization.{" "}
                    <a
