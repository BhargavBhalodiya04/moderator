...
import { trackEvent, ModeratorEvent } from "@/lib/analytics/tracking";
...
const STEP_CONFIG = [
  { nextLabel: "See Moderator in action" },
  { nextLabel: "Let Moderator recommend fixes" },
...
const MobileOnboarding: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleAbandon = () => {
      ...
      trackEvent(ModeratorEvent.MOBILE_ONBOARDING_ABANDONED, {
