  ...
  return (
    <div className="flex flex-col gap-4 px-1">
      <p className="comet-body-s text-muted-slate">
        Ollie is Moderator&apos;s AI coding assistant. When you connect your repo,
        Ollie can inspect your code, help add Moderator tracing, and guide you
        through setup.
      </p>
      <div className="flex flex-col">
        <TimelineStep number={1}>
          <div className="flex flex-col gap-2.5">
            <h4 className="comet-body-s-accented">Install Moderator</h4>
        ...
        <TimelineStep isLast completed={connected}>
          <div className="flex flex-col gap-1">
            ...
            <p className="comet-body-xs text-muted-slate">
              {connected ? (
                "Ollie can now inspect your code and help you set up tracing in Moderator."
              ) : (
                <>
