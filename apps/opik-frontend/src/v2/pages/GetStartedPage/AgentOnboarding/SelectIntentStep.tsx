...
const SelectIntentStep: React.FC = () => {
  ...
  const handleNoAgent = () => {
    trackEvent(ModeratorEvent.ONBOARDING_INTENT_SELECTED, { intent: "no-app" });
    if (!demoDataEnabled) {
      ...
      <div className="w-full max-w-[480px]">
        <div className="flex flex-col gap-1.5">
          <p className="comet-body-s text-muted-slate">
            Welcome to Moderator - let&apos;s get you set up
          </p>
        ...
        <div className="flex flex-col gap-3 pt-6">
          <button
            onClick={() => {
              trackEvent(ModeratorEvent.ONBOARDING_INTENT_SELECTED, {
                intent: "has-app",
              });
