    ...
    <div className="flex flex-1 justify-center gap-16 px-10 pt-16">
      <div className="w-full max-w-lg">
        ...
        <p className="comet-body-s mb-8 text-muted-slate">
          Link your agent to Moderator to start using the Agent playground and
          improve performance.
        </p>
        ...
        <div className="flex flex-col">
          <TimelineStep number={1}>
            <div className="flex flex-col gap-2.5">
              ...
              <p className="comet-body-xs text-muted-slate">
                ...
                to your agent&apos;s main function so Moderator can detect and
          ...
          <TimelineStep number={2}>
            <div className="flex flex-col gap-2.5">
              ...
              <p className="comet-body-xs text-muted-slate">
                Install and run the Moderator connector in your terminal (works with
