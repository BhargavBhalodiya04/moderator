...
type ModeratorEventValues = (typeof ModeratorEvent)[keyof typeof ModeratorEvent];
export type ModeratorEventName = ModeratorEventValues extends never
  ? string
  : ModeratorEventValues;

export const trackEvent = (
  event: ModeratorEventName,
