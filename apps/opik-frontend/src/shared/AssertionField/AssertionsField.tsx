...
import ModeratorLeaf from "@/icons/opik-leaf.svg?react";
import ModeratorLeafDark from "@/icons/opik-leaf-dark.svg?react";
...
const AssertionsField: React.FC<AssertionsFieldProps> = ({
  ...
  const LeafIcon = themeMode === THEME_MODE.DARK ? ModeratorLeafDark : ModeratorLeaf;
