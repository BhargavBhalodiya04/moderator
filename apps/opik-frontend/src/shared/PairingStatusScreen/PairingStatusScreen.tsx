...
export interface PairingStatusScreenProps {
  ...
  // Moderator API base URL the CLI was talking to (from `?url=`). Used for
...
function getCopy(props: PairingStatusScreenProps): {
  ...
  if (props.status === "success") {
    const headline =
      props.runnerVariant === "endpoint"
        ? "Your agent is connected to Moderator"
        : "Moderator is connected to your codebase";
    return {
      headline,
  ...
  switch (props.errorKind) {
    ...
    case "unreachable":
      return {
        headline: "Couldn't reach Moderator",
    ...
    case "v1_workspace":
      return {
        ...
        subtitle:
          "Moderator Connect requires Moderator 2.0. Please upgrade your workspace to continue.",
      };
    default:
      return {
        ...
        {showWorkspaceContext && (
          <div className="mt-6 flex flex-col items-center gap-2">
            <p className="comet-body-s text-muted-slate">
              The CLI tried to pair using these Moderator settings:
            </p>
            <dl
            ...
            >
              {props.expectedBaseUrl ? (
                <>
                  <dt className="text-muted-slate">Moderator URL</dt>
