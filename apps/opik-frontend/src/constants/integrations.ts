...
import deepseekCode from "@/integrations/integration-scripts/DeepSeek.py?raw";
// import difyCode from "@/integration-scripts/Dify.py?raw";
import guardrailsaiCode from "@/integrations/integration-scripts/GuardrailsAI.py?raw";
...
export const INTEGRATIONS: Integration[] = [
...

  {
    ...
    installDescription:
      "Run this in your OpenClaw Gateway environment to install the Moderator plugin.",
    additionalSteps: [
      {
      ...
      },
      {
        ...
        description: "Print the active Moderator configuration to verify the setup.",
      ...
      },
      {
        ...
        description:
          'Traces will stream into your "PROJECT_NAME_PLACEHOLDER" Moderator project.',
