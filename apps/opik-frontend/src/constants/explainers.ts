...
export const EXPLAINERS_MAP: Record<EXPLAINER_ID, Explainer> = {
  ...
  [EXPLAINER_ID.hows_the_cost_estimated]: {
    ...
    description:
      "Moderator estimates the cost of each trace by calculating token usage across all LLM calls, using model-specific pricing.",
    type: "help",
  },
  [EXPLAINER_ID.hows_the_thread_cost_estimated]: {
    id: EXPLAINER_ID.hows_the_thread_cost_estimated,
    description:
      "Moderator estimates the cost of each thread by calculating token usage across all Traces and associated LLM calls, applying model-specific pricing.",
    type: "help",
  },
  [EXPLAINER_ID.whats_that_prompt_select]: {
    id: EXPLAINER_ID.whats_that_prompt_select,
    description:
      "Select the LLM-as-a-Judge prompt to use. You can use one of the prompts provided by Moderator, or you can [create your own metrics].",
    type: "help",
  },
  ...
  [EXPLAINER_ID.whats_the_optimizer]: {
    ...
    description:
      "An optimizer is a built-in algorithm from the Moderator Agent Optimizer SDK that improves prompt effectiveness. Each one uses its own strategy and configurable settings to target specific optimization goals.",
    type: "help",
  },
  ...
  [EXPLAINER_ID.prompt_improvement_optimizer]: {
    ...
    description:
      "Looking for advanced optimization algorithms? Check out the Moderator optimizer!",
  },
  ...
  [EXPLAINER_ID.whats_the_optimization_config]: {
    ...
    description:
      "Configure your setup and let Moderator automatically find the best prompt.",
  },
  [EXPLAINER_ID.whats_the_algorithm_section]: {
    id: EXPLAINER_ID.whats_the_algorithm_section,
    description: "How Moderator explores and improves prompt variations.",
  },
  [EXPLAINER_ID.whats_the_test_suite_section]: {
    id: EXPLAINER_ID.whats_the_test_suite_section,
    description: "Data Moderator uses to evaluate prompt variations.",
  },
  [EXPLAINER_ID.whats_the_metric_section]: {
    id: EXPLAINER_ID.whats_the_metric_section,
    description: "How Moderator measures and compares prompt performance.",
  },
