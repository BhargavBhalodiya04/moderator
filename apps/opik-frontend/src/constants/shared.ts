...
export const DEMO_PROJECT_NAME = "Moderator Demo Agent Observability";
...
export const INSTALL_OPIK_SECTION_TITLE =
  "1. Install Moderator using pip from the command line";
...
export const INSTALL_OPIK_DEFAULT_DESCRIPTION =
  "Install Moderator from the command line using pip.";
